...
class ListProfiles extends ListRecords
{
    ...
    // protected static string $view = 'filament.resources.profile-resource.pages.user-profile';

    protected static string $view = 'profile.user-profile';

    protected ?string $subheading = 'Manage your account';
