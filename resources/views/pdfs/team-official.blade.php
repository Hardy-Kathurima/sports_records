...
<body>
  <div>
    <div class="card-content" style="background-image: url('{{ public_path('images/bg-id.jpg') }}'); position:relative; padding:30px; color:white; border-radius:10px;"   >
      ...
      <div class="card-image"  style="position: absolute; top:140px; right:100px;">
        <img src="{{ public_path('storage/'.auth()->user()->teamOfficial->profile_picture) }}" alt="" class="player-image" style=" height: auto;
        max-width: 100%;
        border-radius: 10px;
        margin-top: -10px;">
