...
@if (auth()->user()->registration_type === "Player")
...
<div style="margin-top:30px;">
    <a href="{{ route('generate-id') }}" target="_blank" class="underline px-8" style="padding:0.5rem 2rem; color:white; background:black; ">Download card</a>
  </div>
...
@if (auth()->user()->registration_type === "Referee")
<div class="card-content" style="position: relative margin-top:20px; min-height:400px;    max-width: 700px;
        background-image:url(/images/id-bg.jpg);
        padding: 10px 30px;
        color:white;
